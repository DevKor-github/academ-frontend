...
export default memo(function SearchResults({ keyword, order, page }: ReqSearchCourse) {
...
}, (prev, next) => prev != undefined && next != undefined && prev.keyword === next.keyword && prev.order === next.order && prev.page === next.page);