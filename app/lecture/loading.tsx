...
import Rstyles from './SingleResearchResultView.module.css'
...
export default function loading() {
  return <Box>
    <div className={styles.container}>
      ...
      <SkeletonDiv style={{minHeight : "240px", width: "100%", borderRadius : "24px", backgroundColor: "#00000011", animationDelay: '0.15s'}} >asdf</SkeletonDiv>
      <SkeletonDiv style={{minHeight : "240px", width: "100%", borderRadius : "24px", backgroundColor: "#00000011", animationDelay: '0.3s'}} >asdf</SkeletonDiv>
    </div>
    </Box>
}