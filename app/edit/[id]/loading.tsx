  ...
  >
    ...
    <HStack gap="10px">
      ...
      <VStack gap="20px" style={{ flexWrap: 'wrap' }}>
        ...
        <span className='text-lg'><Skeleton placeholder="강의관리번호" /></span>
        <span className='text-lg'><Skeleton placeholder="강의년도" /></span>
        <span className='text-lg'><Skeleton placeholder="학기" /></span>
