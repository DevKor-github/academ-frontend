...
export default function MyPageEditBasicForm({
  ...
  return (
    ...
    <form className="py-8 h-full transition-all self-center justify-center items-center pl-2 pr-2 flex flex-col gap-8 w-full md:w-1/2" method="post" onSubmit={handleSubmit}>
      ...
      <div className="w-full flex flex-row justify-center items-center">
        ...
        <div className=
          'flex flex-row justify-end gap-x-2 ml-auto *:border *:border-primary-400 *:rounded-full *:text-sm *:py-1 *:px-4 *:text-primary-400'>

          <Link href="/mypage/change-pw">
              비밀번호 수정
          </Link>
