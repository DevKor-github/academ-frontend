...
export default function DeleteAccountForm(props: FormProps<DeleteAccountInputExtended>) {
  return (
    <form onSubmit={props.handleSubmit} className="flex flex-col justify-center items-center h-full w-full p-8">
      <span className="text-3xl font-bold">계정을 삭제하시겠습니까?</span>
      <br />
      <span className="text-xl font-bold">삭제하기 전에 유의사항을 확인하세요.</span>
